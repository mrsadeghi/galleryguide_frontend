...
function EmptyState({ suggestions, onSelect }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%", gap: 16, padding: "24px 16px" }}>
      ...
      <div className="anim-up-3" style={{ display: "flex", gap: 8, flexWrap: "wrap", justifyContent: "center", width: "100%", maxWidth: 500 }}>
        {suggestions.map(s => (
    ...
    <div style={{ display: "flex", height: "100dvh", flexDirection: "column", background: "var(--bg-0)", overflow: "hidden" }}>
      ...
      <header style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <div onClick={onBack} style={{ width: 26, height: 26, borderRadius: "50%", border: "1px solid var(--border-2)", background: "var(--bg-2)", display: "flex", alignItems: "center", justifyContent: "center" }}>
          ...
          <span className="serif-i" style={{ fontSize: isMobile ? 16 : 18, color: "var(--ink)", cursor: "pointer" }} onClick={onBack}>
            Gallery Guide
          </span>
          {!isMobile && (
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          {!isMobile && (
            <button onClick={onBack} style={{
              ...
              onMouseEnter={e => { e.currentTarget.style.color = "var(--gold)"; e.currentTarget.style.borderColor = "var(--border-2)"; }}
          ...
          <div onClick={e => e.stopPropagation()} style={{
            ...
            <div style={{ display: "flex", gap: 10 }}>
              ...
              <button
                ...
                style={{ flex: 1, padding: "10px", background: "#8B3030", border: "none", borderRadius: "var(--r)", color: "white", cursor: "pointer", fontFamily: "'DM Sans', sans-serif", fontSize: 14, fontWeight: 500 }}
              >Delete</button>
            </div>
          </div>
        </div>
